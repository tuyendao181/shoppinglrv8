            ...
            <form method="post" id="upload-image-form_1" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Name Size</label>
                    <input type="text" class="form-control" id="name_category" name="name_size" placeholder="Enter name ">
                  </div>
                  <span class="text-danger error-text name_size_error"></span>
                </div>
                <!-- /.card-body -->
          ...
          <tbody class="table__tbody " id="tb_list">
            ...
            <td class="table-row__td">
                ...
                <div class="table-row__info">
                  <p class="table-row__name">{{$item->name_size}}</p>
