...
<tr class="table-row table-row--chris tr_{{$item->id}}">
    ...
    <td class="table-row__td">
        ...
        <div class="table-row__img"
            style="background:url('{{url('/uploads/')}}/{{ $item->image}}'); background-size: cover;"> </div>
        @else
    ...
    <td class="table-row__td">
        <a class="fancybox2" href="#inline2" id="click_show_edit" data-id="{{$item->id}}">
            <svg version="1.1" class="table-row__edit" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.001 512.001"
                style="enable-background:new 0 0 512.001 512.001;" xml:space="preserve" data-toggle="tooltip"
        ...
        <svg data-toggle="tooltip" data-placement="bottom" title="Delete" version="1.1" id="{{$item->id}}"
            class="table-row__bin delete_category" xmlns="http://www.w3.org/2000/svg"
