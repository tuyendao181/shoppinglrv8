    ...
    <div class="col-md-12">
     ...
     >Add Slider</a></div>
            ...
            <form method="post" id="upload-image-form_1" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" id="description" name="description" placeholder="Enter description" style="width:100%"></textarea> 
                  </div>
        ...
        <div id="inline2" style="width:600px;display: none;">
            <h3 style=" text-align: center;"> Edit Slider</h3>
            <div class="mess_edit" >
           ...
           <form method="post" id="upload-image-form" enctype="multipart/form-data">
                ...
                <input type="hidden" id="custId" name="id" value="">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Heading</label>
                    <input type="text" class="form-control" id="heading_1" name="heading" placeholder="Enter heading">
                  </div>
                  <span class="text-danger error-text heading_error"></span>

                  <div class="form-group">
                    <label for="exampleInputEmail1">Description</label>
                    <textarea class="form-control" rows="3" id="description_1" name="description" placeholder="Enter description" style="width:100%"></textarea> 
                  </div>
                  <span class="text-danger error-text description_error"></span>
                  ...
                  <div class="form-group">
                    ...
                    <span class="text-danger error-text avatar_error" style="display:block" ></span>
                    <br/>
                    <!-- <img id="thumbnil" class="thub_edit" data-url="{{url('/uploads/')}}" style="width:20%; margin-top:10px;"  src="#" alt="image"/> -->
                    <input type="hidden" class="img_old" name="img_old" value=""/>
                  </div>
                </div>
          ...
          <tbody class="table__tbody " id="tb_list">
            ...
            <td class="table-row__td">
              ...
              <td data-column="Policy" class="table-row__td">
                <div class="">
                  <p class="table-row__policy">{{$item->heading}}</p>
                </div>                
              </td>

              <td data-column="Policy" class="table-row__td">
                <div class="">
                  <p class="table-row__policy">{{$item->descriptions}}</p>
                </div>                
              </td>
...
<script>
 $( document ).ready(function() {
          ...
          $(document).on( "click","#click_show_edit", function(e) {
                ...
                var img = $('.thub_edit').attr('data-url');
                console.log(img);
                $('.fancybox2').fancybox();
                $.ajax({
                    type: "get",
                    ...
                    success: function(data){
                       $data=data[0];
                       $('#custId').val($data.id);
                       $('#description_1').val($data.descriptions);
                       $('#heading_1').val($data.heading);
                       $('.img_old').val($data.image);
                    //    var url = img + '/' + $data.image;
                    //    $('.thub_edit').attr('src',url);
