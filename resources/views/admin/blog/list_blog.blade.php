     ...
     >Add Blog</a></div>
        ...
        <div id="inline2" style="width:600px;display: none;">
           ...
           <form method="post" id="upload-image-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" id="name_1" name="name" placeholder="Enter name">
                  </div>
                  <span class="text-danger error-text name_error"></span>
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Content</label>
                    <input type="text" class="form-control" id="content_1" name="content" placeholder="Enter content">
                  </div>
                  <span class="text-danger error-text content_error"></span>
      ...
      <div class="table-container">
        ...
        <table class="table">
          ...
          <tbody class="table__tbody " id="tb_list">
            ...
            <td data-column="Policy" class="table-row__td">
              <div class="">
                <p class="table-row__policy">{{$item->content}}</p>
              </div>                
            </td>

            <td data-column="Policy" class="table-row__td">
              <div class="">
                <p class="table-row__policy" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;max-width:200px">{{$item->description}}</p>
              </div>                
            </td>
