                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="product-quantity">
                                                 ...
                                                 <input class="quantity input-lg" step="1" min="1" max="99" name="quantity" value="{{ $item['quantity']}}" title="Quantity" type="number" />
                                                 <span data-value="-" class="quantity-btn quantityMinus"></span>
                                             </div>
                                             
                                         </td>
                                         <td class="product-subtotal">
                                             <span class="product-price-sub_totle amount"><span class="currency-sign">$</span>{{$cart->totalPrice}}</span>
                                         </td>
                                     </tr>
                                    @endforeach
                                 </tbody>
